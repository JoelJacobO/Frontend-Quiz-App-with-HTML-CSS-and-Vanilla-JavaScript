...
const nextBtn = document.querySelector(
  ".html-question--container .access-question--bottom .access-buttons .button-submit"
);
...
async function displayHTMLQuiz(index) {
  ...
  const questionCountContent = document.querySelector(
    ".html-question--container .html-question-text .question-count"
  );
  ...
  //   Question
  const htmlQuestionText = document.querySelector(
    ".html-question--container .html-question-text h2"
  );
  const questionTag = ` <span>${data[index].question}</span>`;
  htmlQuestionText.innerHTML = questionTag;

  //   Options

  const optiontags =
    '<button class="btn btn-html"><div><span>A</span><div class="choice">' +
    escapeHTML(data[index].options[0]) +
    "</div></div><div></div></button>" +
    '<button class="btn btn-html"><div><span>B</span><div class="choice">' +
    escapeHTML(data[index].options[1]) +
    "</div></div><div></div></button>" +
    '<button class="btn btn-html"><div><span>C</span><div class="choice">' +
    escapeHTML(data[index].options[2]) +
    "</div></div><div></div></button>" +
    '<button class="btn btn-html"><div><span>D</span> <div class="choice">' +
